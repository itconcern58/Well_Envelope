...
@Component({
  selector: 'app-modal-pi-calc',
  templateUrl: './modal-pi-calc.component.html',
  styleUrls: ['./modal-pi-calc.component.scss']
})
export class ModalPICalcComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ModalPICalcComponent>,
...
/**---------------------------- */
  ...
  calcPInext() {
    ...
    calcPICalc() {
      this.resultPICalc = Number((parseFloat(this.number1)/(this.currentyIntercept-this.currentPressureData[0])).toFixed(2));
    }
